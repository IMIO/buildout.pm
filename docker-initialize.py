...
class Environment(object):
    ...
    def __init__(
        self,
        env=os.environ,
        zope_conf="/home/imio/imio-pm/parts/instance1/etc/zope.conf",
        custom_conf="/home/imio/imio-pm/custom.cfg",
        zeopack_conf="/home/imio/imio-pm/bin/zeopack",
        zeoserver_conf="/home/imio/imio-pm/parts/zeoserver/etc/zeo.conf",
    ):
        self.env = env
...
ZEO_TEMPLATE = """
    <zeoclient>
      ...
      blob-dir /home/imio/imio-pm/var/blobstorage
      shared-blob-dir {shared_blob_dir}
      server {zeo_address}
      storage {zeo_storage}
      name zeostorage
      var /home/imio/imio-pm/parts/instance1/var
